...
命令|解释
:---:|:---:
`nc -u 127.0.0.1 7777` | 发送 UDP 包
`echo "hello" \| nc -u 127.0.0.1 7777` | 发送字符串 UDP 包
`echo -e "\x01\x02\x03\x04" \| nc -u 127.0.0.1 7777` | 发送二进制 UDP 包
`nc -u 127.0.0.1 777 < data` | 发送文件内容
